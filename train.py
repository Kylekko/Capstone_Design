...
data = np.concatenate([
    ...
    np.load('dataset/seq_수어.npy'),
    np.load('dataset/seq_팀.npy'),
    np.load('dataset/seq_입니다.npy'),
    np.load('dataset/seq_발표.npy'),
    np.load('dataset/seq_시작.npy'),
    np.load('dataset/seq_하겠습니다.npy'),
    np.load('dataset/seq_감사합니다.npy'),
    np.load('dataset/seq_dot.npy'),
    np.load('dataset/seq_삭제.npy')
], axis=0)
